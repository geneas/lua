...
local function istable(v)
	return type(v) == "table" and v ~= NIL
end
local function isvalue(v)
	return v ~= nil and type(v) ~= "table" or v == NIL
end
...
tabular.mkentry			= mkentry
tabular.clone				= clone
tabular.merge				= merge
tabular.topup				= topup
tabular.remove				= remove
tabular.keep				= keep
tabular.mapa				= mapa
...
tabular.rotate				= rotate
tabular.comprehend		= comprehend

tabular.tcompare			= tcompare
...
tabular.spairs				= spairs
tabular.deepcopy 			= deepcopy
	
tabular.gtable				= gtable
tabular.g2table			= g2table
tabular.ginline			= ginline
tabular.g2inline			= g2inline
